...
const translations = {
    en: {
        ...
        "social.subtitle": "Follow us on social media to stay updated with our latest sustainable solutions.",
    ...
    ar: {
        ...
        "products.title": "سبعة منتجات تحت علامة إيكوفيرا.",
        "prod.bsf-oil.title": "زيت الحشرات",
        "prod.bsf-oil.weight": "50 كجم",
        "prod.bsf-oil.copy": "زيت حشرات طبيعي مضاد للبكتيريا متعدد الاستخدامات للتطبيقات الصناعية والأعلاف.",
        "prod.frass.title": "سماد حيوي (Frass)",
        "prod.frass.weight": "50 كجم",
        "prod.frass.copy": "سماد عضوي يحسن خصوبة التربة والاحتفاظ بالمياه؛ معتمد وجاهز للتصدير.",
        "prod.roll.title": "علف بروتيني كامل الدسم",
        "prod.roll.weight": "25 كجم",
        "prod.roll.copy": "علف عالي البروتين من يرقات ذبابة الجندي الأسود للدواجن والاستزراع المائي؛ بديل مستدام لمسحوق السمك.",
        "prod.powder.title": "مسحوق بروتين نقي",
        "prod.powder.weight": "25 كجم",
        "prod.powder.copy": "مسحوق بروتين مركز مثالي لتطبيقات الأعلاف المتخصصة.",
        "prod.dried.title": "يرقات مجففة",
        "prod.dried.weight": "10 كجم",
        "prod.dried.copy": "يرقات ذبابة الجندي الأسود المجففة بالكامل، تحافظ على العناصر الغذائية الطبيعية لجودة علف مثالية.",
        "prod.bsf.title": "ذبابة الجندي الأسود",
        "prod.bsf.weight": "غير متوفر",
        "prod.bsf.copy": "خط إنتاج ممتاز لذبابة الجندي الأسود.",
        "prod.chitin.title": "كيتين",
        "prod.chitin.weight": "غير متوفر",
        "prod.chitin.copy": "بوليمر حيوي طبيعي مستخرج من ذبابة الجندي الأسود للتطبيقات الصناعية والزراعية.",
        ...
        "social.title": "انضم إلى مجتمعنا",
        "social.subtitle": "تابعنا على وسائل التواصل الاجتماعي لتبقى على اطلاع بأحدث حلولنا المستدامة.",
