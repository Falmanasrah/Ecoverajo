...
const translations = {
    en: {
        ...
        "products.title": "Four Products Under the Ecovera Label.",
        "prod.1.title": "Protein Feed",
        "prod.1.weight": "25 KG",
        "prod.1.copy": "High-protein feed from BSF larvae for poultry & aquaculture; a sustainable alternative to fishmeal.",
        "prod.2.title": "Bio Fertilizer",
        "prod.2.weight": "50 KG",
        "prod.2.copy": "Organic fertilizer that improves soil fertility & water retention; certified and export-ready.",
        "prod.3.title": "Insect Oil",
        "prod.3.weight": "50 KG",
        "prod.3.copy": "Natural, anti-bacterial, multi-purpose BSF oil for feed and industrial applications.",
        "prod.4.placeholder": "BSF Compost · 50 KG",
        "prod.4.title": "BSF Compost",
        "prod.4.weight": "50 KG",
        "prod.4.copy": "Premium organic compost rich in micronutrients and beneficial soil microbes for high-yield agriculture.",
